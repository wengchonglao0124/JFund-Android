...
public class ChangePassword extends AppCompatActivity {
    ...
    private static final String PATH_CHANGE_PWD = "/changePswd";
    ...
    private JSONObject parseInfo(){
        ...
        try {
            json_body.put("oldPswd", password1.getText().toString());
            json_body.put("newPswd", password3.getText().toString());
    ...
    private void changePassword(JSONObject json_body){
        new Thread(){
            @Override
            public void run() {
